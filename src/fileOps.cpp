...
void load_configFile(SettingsData* pSetting){
  ...
  pSetting->wd.aneometer.AneometerType = eAneometer(preferences.getUChar("GSANEO",eAneometer::DAVIS));
  pSetting->wd.aneometer.AneometerAdsGain = preferences.getUChar("WDANEOADSGAIN",2);;
  pSetting->wd.aneometer.AneometerAdsWSpeedMinVoltage = preferences.getFloat("WDANEOADSWSMINV",0.0);
  pSetting->wd.aneometer.AneometerAdsWSpeedMaxVoltage = preferences.getFloat("WDANEOADSWSMAXV",10.0);
  pSetting->wd.aneometer.AneometerAdsWDirMinVoltage = preferences.getFloat("WDANEOADSWDMINV",0.0);
  pSetting->wd.aneometer.AneometerAdsWDirMaxVoltage = preferences.getFloat("WDANEOADSWDMAXV",10.0);
  pSetting->wd.aneometer.AneometerAdsWSpeedMinSpeed = preferences.getFloat("WDANEOADSWSMINS",0.0);
...
void write_configFile(SettingsData* pSetting){
  ...
  preferences.putFloat("WDANEOADSWSMINV", pSetting->wd.aneometer.AneometerAdsWSpeedMinVoltage);
  preferences.putFloat("WDANEOADSWSMAXV", pSetting->wd.aneometer.AneometerAdsWSpeedMaxVoltage);
  preferences.putFloat("WDANEOADSWDMINV", pSetting->wd.aneometer.AneometerAdsWDirMinVoltage);
  preferences.putFloat("WDANEOADSWDMAXV", pSetting->wd.aneometer.AneometerAdsWDirMaxVoltage);
  preferences.putFloat("WDANEOADSWSMINS", pSetting->wd.aneometer.AneometerAdsWSpeedMinSpeed);
  preferences.putFloat("WDANEOADSWSMAXS", pSetting->wd.aneometer.AneometerAdsWSpeedMaxSpeed);
  preferences.putFloat("WDANEOADSWDMIND", pSetting->wd.aneometer.AneometerAdsWDirMinDir);
  preferences.putFloat("WDANEOADSWDMAXD", pSetting->wd.aneometer.AneometerAdsWDirMaxDir);
