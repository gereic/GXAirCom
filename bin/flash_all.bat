...
%esptooldir%esptool.exe --chip esp32 -p %PORT% -b 57600 write_flash 0x1000 bootloader_dio_40m.bin 0x8000 partitions.bin 0xe000 boot_app0.bin 0x10000 %firmware% 0x3d0000 %spiffs%