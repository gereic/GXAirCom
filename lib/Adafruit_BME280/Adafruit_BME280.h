...
protected:
  ...
  int32_t calcTemperature(void);
  uint32_t calcPressure(void);
  uint32_t calcHumidity(void);  
  ...
  int32_t adc_T; //adc-Value of temperature
  int32_t adc_P; //adc-Value of pressure
  int32_t adc_H; //adc-Value of humidity
  int32_t iTemp; //actual value of temperature
  uint32_t uiPressure; //actual value of pressure
  uint32_t uiHumidity; //actual value of humidity
  /**************************************************************************/
  /*!
